...
Welcome to CSC 211 Lab 08. Your goal for this lab will be to gain a better understanding of classes. **Be sure to read and follow all instructions unless otherwise specified.**  Create a `lab--08.txt` document to record all of your lab answers in and implement all of your `.cpp` programs in your IDE.

1. Part 1: Class Overview [30 mins]<br>
2. Exercises [75 mins]<br>
3. Part 2: Creating a 'string' class
...
## Part 2: Creating a 'string' class
...
:white_check_mark: 3. Think about the data members this class needs, and implement them. Use the description of the class to infer what you need.

:white_check_mark: 4. Implement all functions declared in the header file for the `MyString` class.
...
:white_check_mark: 5. Pick a method from http://www.cplusplus.com/reference/string/string/ that you haven't yet implemented and implement it.
